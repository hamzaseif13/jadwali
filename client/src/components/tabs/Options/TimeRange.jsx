    ...
    return (
        <div >
            <div className="mt-2">
                ...
                <button className="rounded bg-blue-500 p-1 px-4 active:bg-mylight" onClick={()=>handleChange(2)}>+</button>
            </div>
            <div className="mt-2">
                <h1>End time</h1>
                <button className="rounded bg-blue-500 p-1 px-4 mr-2 ml-2 active:bg-mylight" onClick={()=>handleChange(3)}>-</button>
                ...
                <button className="rounded bg-blue-500 p-1 px-4 active:bg-mylight" onClick={()=>handleChange(4)}>+</button>
            </div>
        </div>
    )
}

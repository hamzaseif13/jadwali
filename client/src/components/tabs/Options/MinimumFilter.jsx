      ...
      <div>
        <button
          className={`rounded ml-2 ${
            minNumberOfDays === 1 ? "bg-mylight" : "bg-blue-500"
        ...
        <input
          ...
          className=" mx-2 w-20 text-center bg-mylight text-blue-500 p-1 rounded mt-1"
          min="1"
          max="5"
          name="minDays"
        />
        <button
          className={`rounded  ${
            minNumberOfDays === 5 ? "bg-mylight" : "bg-blue-500"
          } p-1 px-4 active:bg-mylight`}
          onClick={() => handleChange(1)}>
          +
        </button>
